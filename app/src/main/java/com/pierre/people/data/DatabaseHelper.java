...
import static com.pierre.people.data.PeopleContract.PeopleTable.COL_EMAIL;
import static com.pierre.people.data.PeopleContract.PeopleTable.COL_NAME;
import static com.pierre.people.data.PeopleContract.PeopleTable.COL_NUMBER;
import static com.pierre.people.data.PeopleContract.PeopleTable.COL_TYPE;
import static com.pierre.people.data.PeopleContract.PeopleTable.TABLE_NAME;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(PeopleContract.PeopleTable.CREATE_PEOPLE_TABLE);
        Log.d(TAG, PeopleContract.DATABASE_NAME + " created");
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL(PeopleContract.PeopleTable.DELETE_TABLE);
        onCreate(db);
    }
