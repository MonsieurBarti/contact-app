...
import com.pierre.people.adapter.PersonDetailsAdaptor;
...
public class ViewPersonFragment extends Fragment {
    ...
    private void init() {
        ...
        PersonDetailsAdaptor personDetailsAdaptor = new PersonDetailsAdaptor(getActivity(), R.layout.card, details);
